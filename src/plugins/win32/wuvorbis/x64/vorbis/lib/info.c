...
#if	defined(__SSE3__)&&defined(_OPENMP)
  char temp[]="BS; Lancer(SSE3MT) [" CPDATE "] (based on aoTuV b5 [20061024])";
#elif defined(__SSE3__)
  char temp[]="BS; Lancer(SSE3) [" CPDATE "] (based on aoTuV b5 [20061024])";
#elif defined(__SSE2__)&&defined(_OPENMP)
  char temp[]="BS; Lancer(SSE2MT) [" CPDATE "] (based on aoTuV b5 [20061024])";
