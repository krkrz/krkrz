...
enum {
	...
	NUM_TJS_NARROW_TO_WIDE_CONVERSION_ERROR_ANSI,
	...
	NUM_TVP_PASSTHROUGH_FAILED_TO_CREATE_DIRECT3DDEVICES,
	NUM_TVP_PASSTHROUGH_FAILED_TO_CREATE_DIRECT3DDEVICES_UNKNOWN_REASON,
	NUM_TVP_PASSTHROUGH_TEXTURE_HAS_ALREADY_BEEN_LOCKED,
	NUM_TVP_INTERNAL_ERROR_RESULT,
	NUM_TVP_ERROR_DEVICE_LOST_CANNOT_RESET_DEVICE,
	NUM_TVP_ERROR_DEVICE_INTERNAL_FATAL_ERROR,
	NUM_TVP_ERROR_INVALID_CALL,
	NUM_TVP_ERROR_CANNOT_ALLOCATE_VIDEO_MEMORY,
	NUM_TVP_ERROR_CANNOT_ALLOCATE_MEMORY,
	NUM_TVP_PASSTHROUGH_INF_POLYGON_DRAWING_FAILED,
	NUM_TVP_PASSTHROUGH_INF_PRIMARY_SURFACE_DIRECT3DDEVICE_PRESENT_FAILED,
	...
	NUM_TVP_PASSTHROUGH_FAILED_TO_SET_DESTINATION_POSITION,
	NUM_TVP_PASSTHROUGH_FAILED_TO_SET_DESTINATION_SIZE,
	NUM_TVP_PASSTHROUGH_FAILED_TO_CREATE_DRAWER,
	NUM_TVP_PASSTHROUGH_FAILED_TO_CREATE_DRAWER_UNKNOWN_REASON,
	NUM_TVP_PASSTHROUGH_COULD_NOT_CREATE_DRAWER,
	NUM_TVP_PASSTHROUGH_DRAWER_NOT_SUPPORT_SMOOTH_ZOOM,
	NUM_TVP_PASSTHROUGH_DRAWER_NOT_SUPPORT_POINT_ON_POINT_ZOOM,
	NUM_TVP_PASSTHROUGH_BENCHMARK_RESULT,
	NUM_TVP_COULD_NOT_CREATE_ANY_DRAW_DEVICE,
	NUM_TVP_PASSTHROUGH_USING_PASSTHROUGH_DRAW_DEVICE,
	NUM_TVP_PASS_THROUGH_DEVICE_DOES_NOT_SUPPORTE_LAYER_MANAGER_MORE_THAN_ONE,
...
const int RESOURCE_IDS[NUM_MESSAGE_MAX] = {
	...
	IDS_TJS_NARROW_TO_WIDE_CONVERSION_ERROR_ANSI,
	...
	IDS_TVP_PASSTHROUGH_FAILED_TO_CREATE_DIRECT3DDEVICES,
	IDS_TVP_PASSTHROUGH_FAILED_TO_CREATE_DIRECT3DDEVICES_UNKNOWN_REASON,
	IDS_TVP_PASSTHROUGH_TEXTURE_HAS_ALREADY_BEEN_LOCKED,
	IDS_TVP_INTERNAL_ERROR_RESULT,
	IDS_TVP_ERROR_DEVICE_LOST_CANNOT_RESET_DEVICE,
	IDS_TVP_ERROR_DEVICE_INTERNAL_FATAL_ERROR,
	IDS_TVP_ERROR_INVALID_CALL,
	IDS_TVP_ERROR_CANNOT_ALLOCATE_VIDEO_MEMORY,
	IDS_TVP_ERROR_CANNOT_ALLOCATE_MEMORY,
	IDS_TVP_PASSTHROUGH_INF_POLYGON_DRAWING_FAILED,
	IDS_TVP_PASSTHROUGH_INF_PRIMARY_SURFACE_DIRECT3DDEVICE_PRESENT_FAILED,
	...
	IDS_TVP_PASSTHROUGH_FAILED_TO_SET_DESTINATION_POSITION,
	IDS_TVP_PASSTHROUGH_FAILED_TO_SET_DESTINATION_SIZE,
	IDS_TVP_PASSTHROUGH_FAILED_TO_CREATE_DRAWER,
	IDS_TVP_PASSTHROUGH_FAILED_TO_CREATE_DRAWER_UNKNOWN_REASON,
	IDS_TVP_PASSTHROUGH_COULD_NOT_CREATE_DRAWER,
	IDS_TVP_PASSTHROUGH_DRAWER_NOT_SUPPORT_SMOOTH_ZOOM,
	IDS_TVP_PASSTHROUGH_DRAWER_NOT_SUPPORT_POINT_ON_POINT_ZOOM,
	IDS_TVP_PASSTHROUGH_BENCHMARK_RESULT,
	IDS_TVP_COULD_NOT_CREATE_ANY_DRAW_DEVICE,
	IDS_TVP_PASSTHROUGH_USING_PASSTHROUGH_DRAW_DEVICE,
	IDS_TVP_PASS_THROUGH_DEVICE_DOES_NOT_SUPPORTE_LAYER_MANAGER_MORE_THAN_ONE,
...
void TVPLoadMessage() {
	...
	TJSNarrowToWideConversionError.AssignMessage( RESOURCE_MESSAGE[NUM_TJS_NARROW_TO_WIDE_CONVERSION_ERROR_ANSI] );
#else
	...
	TVPUnknonwError.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_UNKNONW_ERROR] );
	...
	TVPPassthroughFailedToCreateDirect3DDevices.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_FAILED_TO_CREATE_DIRECT3DDEVICES] );
	TVPPassthroughFailedToCreateDirect3DDevicesUnknownReason.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_FAILED_TO_CREATE_DIRECT3DDEVICES_UNKNOWN_REASON] );
	TVPPassthroughTextureHasAlreadyBeenLocked.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_TEXTURE_HAS_ALREADY_BEEN_LOCKED] );
	TVPInternalErrorResult.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_INTERNAL_ERROR_RESULT] );
	TVPErrorDeviceLostCannotResetDevice.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_ERROR_DEVICE_LOST_CANNOT_RESET_DEVICE] );
	TVPErrorDeviceInternalFatalError.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_ERROR_DEVICE_INTERNAL_FATAL_ERROR] );
	TVPErrorInvalidCall.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_ERROR_INVALID_CALL] );
	TVPErrorCannotAllocateVideoMemory.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_ERROR_CANNOT_ALLOCATE_VIDEO_MEMORY] );
	TVPErrorCannotAllocateMemory.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_ERROR_CANNOT_ALLOCATE_MEMORY] );
	TVPPassthroughInfPolygonDrawingFailed.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_INF_POLYGON_DRAWING_FAILED] );
	TVPPassthroughInfPrimarySurfaceDirect3DDevicePresentFailed.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_INF_PRIMARY_SURFACE_DIRECT3DDEVICE_PRESENT_FAILED] );
	...
	TVPPassthroughFailedToSetDestinationPosition.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_FAILED_TO_SET_DESTINATION_POSITION] );
	TVPPassthroughFailedToSetDestinationSize.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_FAILED_TO_SET_DESTINATION_SIZE] );
	TVPPassthroughFailedToCreateDrawer.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_FAILED_TO_CREATE_DRAWER] );
	TVPPassthroughFailedToCreateDrawerUnknownReason.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_FAILED_TO_CREATE_DRAWER_UNKNOWN_REASON] );
	TVPPassthroughCouldNotCreateDrawer.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_COULD_NOT_CREATE_DRAWER] );
	TVPPassthroughDrawerNotSupportSmoothZoom.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_DRAWER_NOT_SUPPORT_SMOOTH_ZOOM] );
	TVPPassthroughDrawerNotSupportPointOnPointZoom.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_DRAWER_NOT_SUPPORT_POINT_ON_POINT_ZOOM] );
	TVPPassthroughBenchmarkResult.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_BENCHMARK_RESULT] );
	TVPCouldNotCreateAnyDrawDevice.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_COULD_NOT_CREATE_ANY_DRAW_DEVICE] );
	TVPPassthroughUsingPassthroughDrawDevice.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASSTHROUGH_USING_PASSTHROUGH_DRAW_DEVICE] );
	TVPPassThroughDeviceDoesNotSupporteLayerManagerMoreThanOne.AssignMessage( RESOURCE_MESSAGE[NUM_TVP_PASS_THROUGH_DEVICE_DOES_NOT_SUPPORTE_LAYER_MANAGER_MORE_THAN_ONE] );
